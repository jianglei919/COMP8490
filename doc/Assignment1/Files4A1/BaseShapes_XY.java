...
public abstract class BaseShapes_XY {
...
class SquareShape extends BaseShapes_XY {
	public SquareShape() {
...
class ColorString extends BaseShapes_XY {
	String str;
	Color3f clr;
	double scl;
	...
	protected Node create_Object() {
		...
		Appearance app = CommonsXY.obj_Appearance(clr);    // use appearance to specify the string color
