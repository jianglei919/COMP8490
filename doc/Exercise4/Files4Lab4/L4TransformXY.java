...
public class L4TransformXY extends GroupObjects {
	...
	public static Shape3D ring_Side(int shape_key, Color3f clr) {
		...
		Point3f c_pts[] = L2StarXY.circle_Points(0, r, MAX_PTS);                
		...
		Appearance app = CommonsXY.set_Appearance(clr);
	...
	public L4TransformXY(int key) {
		super(ring_Side(key, CommonsXY.Green));
	}
}
