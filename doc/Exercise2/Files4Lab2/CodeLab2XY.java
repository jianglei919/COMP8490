...
public class CodeLab2XY extends JPanel implements ActionListener {

	private static final long serialVersionUID = 1L;
	private static JFrame frame;
	
	private static String frame_name = "XY's Lab #2";
	...
	private static BranchGroup create_Scene() {
		...
		groupObject = new GroupObjects(L2StarXY.line_Shape(0.6f)); 
	...
	public CodeLab2XY(BranchGroup scene) {
		...
		CommonsXY.define_Viewer(su, new Point3d(1.35, -0.35, 1.5)); 		
	...
	public static void main(String[] args) {
		...
		frame.getContentPane().add(new CodeLab2XY(create_Scene()));
	...
	public void actionPerformed(ActionEvent e) {
		...
		case OBJECT_NAME:                                  // change object shape and name
			if (object_tag) {
				groupObject = new GroupObjects(L2StarXY.line_Shape(0.3f));
