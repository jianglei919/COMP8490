...
public class CodeLab3LJ extends JPanel implements ActionListener {
    ...
    private static float radiusFor(DiskSize s) {
        switch (s) {
            ...
            case TINY:   return 0.5f;
        }
        return 2.0f;
    }
    private static String labelFor(DiskSize s) {
        switch (s) {
            case BIG:    return "BIG (r=2.0)";
            case MEDIUM: return "MEDIUM (r=1.5)";
            case SMALL:  return "SMALL (r=1.0)";
            case TINY:   return "TINY (r=0.5)";
        }
        return "";
    }
    private static void cycleSize() {
        switch (diskSize) {
            case BIG:    diskSize = DiskSize.MEDIUM; break;
            case MEDIUM: diskSize = DiskSize.SMALL;  break;
            case SMALL:  diskSize = DiskSize.TINY;   break;
            case TINY:   diskSize = DiskSize.BIG;    break;
        }
    }
